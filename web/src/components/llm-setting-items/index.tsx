...
import CustomSwitch from '@/pages/chat/chat-configuration-modal/custom-switch';
import { QuestionCircleOutlined } from '@ant-design/icons';
import { Flex, Form, InputNumber, Select, Slider, Tooltip } from 'antd';
...
const LlmSettingItems = ({ prefix, formItemLayout = {}, onChange }: IProps) => {
  ...
  return (
    <>
      <Form.Item label={t('model')} tooltip={t('modelTip')} {...formItemLayout}>
        <Select
          value="qwen3-32B"
          options={[
            {
